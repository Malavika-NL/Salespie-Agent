...
import { accountForm, clearAccountData } from './slice/accountFormSlice'
...
const AccountForm = () => {
    ...
    const data = useSelector((state: RootState) => state.acountForm.data);
    console.log(data)
    ...
    useEffect(() => {
        if (isFormSubmitted) {
            if (data?.message === 'Success') {
                ...
                alert('Account form Failed to  submitted.');
                setIsFormSubmitted(false);
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (token) {
            // dispatch(accountForm(formData) as any);
            dispatch(refreshTokenReq() as any);
        } else {
                ...
                <form className={styles.form} onSubmit={handleSubmit}>
                    ...
                    <div className={styles.leftContainer} >
                        ...
                        <div className={styles.inputLeftGroup}>
                            ...
                            />
                            <label className={styles.leftlabel} htmlFor="account_name">Account Holder</label>
                        </div>
