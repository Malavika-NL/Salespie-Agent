...
// import { fetchAdminPieChartData } from './slice/AdminPieChart';
// import styles from './AdminPieChart.module.css';
...
// const AdminPieChartComponent: React.FC = () => {
//   const dispatch = useDispatch();

//   useEffect(() => {
//     dispatch(fetchAdminPieChartData() as any);
//   }, [dispatch]);

//   const pieData = useSelector((state: RootState) => state.fetchAdminPieChart.userpiedata);
        ...
        <ResponsiveContainer width="100%" height={270} minWidth={240}>
          <PieChart>
            <Pie
              ...
              labelLine={false}
              label={({
                name, value, cx, cy, midAngle, outerRadius: or, index,
              }) => {
                const RADIAN = Math.PI / 180;
                const radius = or + 22;
                const x = cx + Math.cos(-midAngle * RADIAN) * radius;
