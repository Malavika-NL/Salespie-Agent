...
import home from './userdashboard.module.css';
...
const UserDashboard = () => {
  ...
  dispatch(setTokens(token) as any);
        ...
        <div className={home.mainContent}>
          ...
          <div className={home.contentContainer}>
            ...
            <div className={home.dashboardContainer}>
              <Link to='/dashboard' className={home.link} > <DashboardPage /></Link>
          ...
          <Link to="#" className={home.link}><h3>Route Map</h3></Link>
          </div>
          ...
          <div className={home.newMainContainer}>
            ...
            <div className={home.leftContainer}>
              <div className={home.heatmap}>
                ...
                <Link to="#" className={home.link}><h3>Heatmap</h3></Link>
              </div>
