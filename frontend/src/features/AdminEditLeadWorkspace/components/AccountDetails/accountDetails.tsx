...
// import { setFormData } from "../../slice/AdminEditLeadWorkspaceSlice";
...
const AccountDetails: React.FC<AccountDetailsProps> = ({ errors }) => {
  ...
  // Find the selected make from 'makes' data
  const leadHierarchyOptions = accountFormSettings.leadHierarchy?.length ? accountFormSettings.leadHierarchy : makes;
  const opportunityOptions = accountFormSettings.opportunities?.length
      ...
      <div className="rounded-2xl border-2 border-violet-100 shadow-lg">
        ...
        <div className="bg-white px-5 py-4 rounded-b-2xl">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-x-4 gap-y-4">
            ...
            {/* Account Name */}
            {/* account_holder commented out in original — preserved */}
            ...
            {/* Region — commented out in original, preserved */}
            {/* <div className="flex flex-col gap-1.5">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <select id="state" value={formData ? formData.state : ''} className={selectClass(formData?.state)} onChange={handleInputChange}>
                <option>Select state</option>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <select id="city" value={formData ? formData.city : ''} className={selectClass(formData?.city)} onChange={handleInputChange}>
                <option>Select city</option>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-4">
              {[
                ...
                <div key={id} className="flex items-center gap-3">
                  ...
                  <input type="number" id={id} value={(formData as any)?.[id] ?? ''} onChange={handleInputChange} placeholder="Enter the amount" className={amountInputClass} />
                </div>
              ))}
              {/* Total */}
