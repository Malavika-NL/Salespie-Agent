...
// import { addStage } from "../../slice/LeadWorkspace";
...
const StageData: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (stage) { dispatch(addStage(stageData)); }
  }, [stage, lostReason, showLostReason, dispatch]);
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="flex items-center gap-6">
              <label className="flex items-center gap-2 cursor-pointer text-sm font-medium text-slate-700">
                <input type="radio" name="lostReason" value="yes" checked={showLostReason} onChange={handleCheckboxChange} className="accent-violet-600 w-4 h-4" />
                Yes
              </label>
              <label className="flex items-center gap-2 cursor-pointer text-sm font-medium text-slate-700">
                <input type="radio" name="lostReason" value="no" checked={!showLostReason} onChange={handleCheckboxChange} className="accent-violet-600 w-4 h-4" />
                No
              </label>
            </div>
          </div>
