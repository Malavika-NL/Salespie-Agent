// src/features/Editopportunityworkspace/components/Bar/componetns/Taskcreation/TaskCreationForm/TaskCreationForm.tsx
// import React, { useState } from "react";
// import { useDispatch } from "react-redux";

// import styles from "./TaskCreationForm.module.css";
// import { addTaskDetails } from "../../../../../slice/EditOpportunityWorkspace";
...
//     if (!form.task.trim()) newErrors.task = "Task description is required.";
...
const selectClass = (hasError: boolean, value: string) =>
  `w-full px-3 py-2 rounded-xl border-2 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-blue-600 transition-all duration-200 bg-white [&>option]:text-slate-800 [&>option]:font-medium ${
    hasError
      ? "border-red-400 bg-red-50 focus:ring-red-400 focus:border-red-400 text-slate-800"
      : "border-slate-200"
        ...
        <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select
              ...
              onChange={handleChange}
              className={selectClass(!!errors.assign_to, form.assign_to)}
            >
              <option value="">Select Assignee</option>
              <option value="event1">Event 1</option>
              <option value="event2">Event 2</option>
