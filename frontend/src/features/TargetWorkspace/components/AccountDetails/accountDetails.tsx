...
// import { setFormData } from "../../Slice/TargetWorkspaceSlice";
      ...
      <div className="bg-white px-5 py-4 rounded-b-2xl">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-x-4 gap-y-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input ref={accountNameRef} type="text" id="account_name"
              value={formData ? formData.account_name : ''}
              onChange={handleInputChange} placeholder="Enter Account Name" className={inputClass} />
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input type="text" id="remarks" value={formData ? formData.remarks : ''} onChange={handleInputChange} placeholder="Enter Remarks" className={inputClass} />
          </div>

          {/* Activity */}
          <div className="flex flex-col gap-1.5">
            <label htmlFor="activity" className="text-sm font-semibold text-slate-700">Activity</label>
            <select id="activity" className={selectClass(formData?.activity)} value={formData ? formData.activity : ''} onChange={handleInputChange}>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select id="next_action" className={selectClass(formData?.next_action)} value={formData ? formData.next_action : ''} onChange={handleInputChange}>
              <option>Select a Next Action</option>
              {activityOptions.map((o, i) => <option key={i} value={o.type}>{o.type}</option>)}
            </select>
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input type="date" id="next_action_date" value={formData ? formData.next_action_date : ''} onChange={handleInputChange} className={inputClass} />
          </div>

          {/* Activity Date */}
          <div className="flex flex-col gap-1.5">
            <label htmlFor="activity_date" className="text-sm font-semibold text-slate-700">Activity Date</label>
            <input type="date" id="activity_date" value={formData ? formData.activity_date : ''} onChange={handleInputChange} className={inputClass} />
          </div>
          ...
          <div className="flex flex-col gap-1.5 sm:col-span-2">
            ...
            <textarea id="address"
              ...
              value={formData ? formData.address : ''} onChange={handleInputChange} placeholder="Enter Address" />
          </div>
