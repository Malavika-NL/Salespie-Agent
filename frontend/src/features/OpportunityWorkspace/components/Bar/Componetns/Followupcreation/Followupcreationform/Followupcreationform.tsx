// // src/features/OpportunityWorkspace/components/Bar/Componetns/FollowupCreation/FollowupCreationForm/FollowupCreationForm.tsx

// import React, { useState } from "react";
// import { useDispatch } from "react-redux";
// import { addFollowupDetails } from "../../../../../slice/opportunitySlice";
...
// const FollowupCreationForm: React.FC = () => {
...
//     setSuccessMsg("Follow-up created successfully!");
...
//           <label style={s.label}>
//             Follow-up <span style={s.required}>*</span>
//           </label>
//           <select
//             name="followup"
//             value={form.followup}
//             onChange={handleChange}
//             style={inputStyle(!!errors.followup)}
//           >
...
//         <div style={s.fieldWrap}>
//           <label style={s.label}>
//             Follow-up Topic <span style={s.required}>*</span>
//           </label>
//           <input
//             type="text"
//             name="followup_topic"
...
//             style={inputStyle(!!errors.followup_topic)}
//           />
...
// export default FollowupCreationForm;
...
// // ─── Shared style helpers (matching Account Workspace) ────────────────────────

// const inputClass = (hasError: boolean) =>
//   `w-full px-3 py-2 rounded-xl border text-sm font-medium placeholder:text-slate-400 placeholder:font-normal focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent transition-all duration-200 bg-white text-slate-800 ${
//     hasError
...
//       {/* Success Banner */}
//       {successMsg && (
//         <div className="flex items-center gap-2 bg-emerald-50 border border-emerald-200 text-emerald-700 px-4 py-3 rounded-xl text-sm font-medium mb-5">
...
//             Follow-up <span className="text-red-500 normal-case text-sm">*</span>
//           </label>
//           <select
//             name="followup"
//             value={form.followup}
//             onChange={handleChange}
//             className={`${inputClass(!!errors.followup)} ${
//               !form.followup ? "text-slate-400 font-normal" : "text-slate-800"
...
//         <div className="flex flex-col gap-1.5">
//           <label className="text-xs font-semibold text-slate-700 uppercase tracking-wide">
//             Follow-up Topic <span className="text-red-500 normal-case text-sm">*</span>
//           </label>
//           <input
//             type="text"
//             name="followup_topic"
...
//             <p className="text-red-500 text-xs flex items-center gap-1 mt-0.5">
//               <span>⚠</span> {errors.followup_topic}
//             </p>
//           )}
//         </div>
...
//           <div className="flex flex-col gap-1.5">
//             <label className="text-xs font-semibold text-slate-700 uppercase tracking-wide">
//               Start Date <span className="text-red-500 normal-case text-sm">*</span>
//             </label>
//             <input
//               type="date"
//               name="start_date"
...
//           <div className="flex flex-col gap-1.5">
//             <label className="text-xs font-semibold text-slate-700 uppercase tracking-wide">
//               End Date <span className="text-red-500 normal-case text-sm">*</span>
//             </label>
//             <input
//               type="date"
//               name="end_date"
...
//           <label className="text-xs font-semibold text-slate-700 uppercase tracking-wide">
//             Remark{" "}
//             <span className="text-slate-400 text-xs font-normal normal-case">
//               (optional)
//             </span>
//           </label>
//           <textarea
...
//             placeholder="Any notes or context for this follow-up..."
//             rows={3}
//             className="w-full px-3 py-2 rounded-xl border border-slate-200 bg-white text-sm text-slate-800 font-medium placeholder:text-slate-400 placeholder:font-normal focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent transition-all duration-200 resize-vertical"
//           />
//         </div>
...
//         <button
//           type="submit"
//           className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold transition-colors duration-200 shadow-sm mt-1"
//         >
//           + Add Follow-up
//         </button>
//       </form>
      ...
      <div className="bg-white px-5 py-4 rounded-b-2xl">
        ...
        <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              type="text" name="followup_topic" value={form.followup_topic}
              onChange={handleChange} placeholder="e.g. Discuss Q3 pricing proposal"
              className={inputClass(!!errors.followup_topic)}
            />
            {errors.followup_topic && (
