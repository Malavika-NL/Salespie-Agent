...
// import { addEventDetails } from "../../../../../slice/opportunitySlice";
...
//   optional: { color: "#9ca3af", fontSize: "10px", fontWeight: 400, textTransform: "none" as const },
...
//     if (form.start_date === form.end_date && form.start_time && form.end_time && form.end_time <= form.start_time)
...
//       <h2 style={styles.heading}>Event Creation</h2>
...
//           </label>
//           <select name="event" value={form.event} onChange={handleChange} style={inputStyle(!!errors.event)}>
//             <option value="">Select an event</option>
//             {EVENT_CHOICES.map(c => <option key={c} value={c}>{c}</option>)}
//           </select>
//           {errors.event && <p style={styles.errorText}>⚠ {errors.event}</p>}
//         </div>
...
//             {errors.start_date && <p style={styles.errorText}>⚠ {errors.start_date}</p>}
//           </div>
//           <div>
...
//             {errors.end_date && <p style={styles.errorText}>⚠ {errors.end_date}</p>}
//           </div>
//         </div>
...
//             <input type="time" name="start_time" value={form.start_time} onChange={handleChange} style={inputStyle(!!errors.start_time)} />
//             {errors.start_time && <p style={styles.errorText}>⚠ {errors.start_time}</p>}
//           </div>
//           <div>
//             <label style={styles.label}>End Time <span style={styles.required}>*</span></label>
//             <input type="time" name="end_time" value={form.end_time} onChange={handleChange} style={inputStyle(!!errors.end_time)} />
//             {errors.end_time && <p style={styles.errorText}>⚠ {errors.end_time}</p>}
//           </div>
//         </div>
...
//         <div style={styles.fieldWrap}>
//           <label style={styles.label}>
//             Remarks <span style={styles.optional}>(optional)</span>
//           </label>
//           <input
//             type="text" name="remark" value={form.remark} onChange={handleChange}
        ...
        <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <input type="time" name="start_time" value={form.start_time} onChange={handleChange} className={inputClass(!!errors.start_time)} />
              {errors.start_time && <p className="text-red-500 text-xs flex items-center gap-1 mt-0.5"><span>⚠</span> {errors.start_time}</p>}
            </div>
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-semibold text-slate-700">
                End Time <span className="text-red-500">*</span>
              </label>
              <input type="time" name="end_time" value={form.end_time} onChange={handleChange} className={inputClass(!!errors.end_time)} />
              {errors.end_time && <p className="text-red-500 text-xs flex items-center gap-1 mt-0.5"><span>⚠</span> {errors.end_time}</p>}
            </div>
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input type="text" name="remark" value={form.remark} onChange={handleChange} placeholder="Add any notes or remarks..." className={inputClass(false)} />
          </div>
