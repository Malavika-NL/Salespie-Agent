...
import { targetForm, clearTargetData } from './slice/targetFormSice';
...
const TargetForm = () => {
    ...
    const data = useSelector((state: RootState) => state.targetForm.data);
    console.log(data)
    ...
    //         alert(' Target form not submitted ');
    //         navigate('/adminDashboard');
    //     }
    ...
    useEffect(() => {
        if (isFormSubmitted) {
            if (data?.message === 'Success') {
                ...
                alert('Target form Failed to  submitted.');
                setIsFormSubmitted(false);
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        dispatch(targetForm(formData) as any);
