...
// import { setFormData } from "../../Slice/EditAdminAccountWorkspaceSlice";
...
interface AccountDetailsValues {
  ...
  state: string; city: string; address: string; acct_created_date: string | null; last_update: string | null;
}
  ...
  return (
    <div className="rounded-2xl border-2 border-indigo-100 shadow-lg overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-blue-500 px-5 py-3 flex items-center gap-2">
        ...
        <h2 className="text-sm font-bold text-white tracking-wide">Account Details</h2>
      </div>
