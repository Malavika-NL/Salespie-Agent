...
import { opportunityForm, clearAccountData } from './slice/opportunityFormSlice';
...
const OpportuntiyForm = () => {
    ...
    const data = useSelector((state: RootState) => state.opportunityForm.data);
    ...
    //         alert(' Opportunity form not submitted ');
    //         navigate('/adminDashboard');
    //     }
    ...
    useEffect(() => {
        if (isFormSubmitted) {
            if (data?.message === 'Success') {
                ...
                alert('Opportunity form Failed to  submitted.');
                setIsFormSubmitted(false);
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        dispatch(opportunityForm(formData) as any);
                        ...
                        <div className={styles.subcontainer}>
                            ...
                            <div className={styles.inputLeftGroup}>
                                <input
                                    ...
                                    required
                                />
                                <label className={styles.leftlabel} htmlFor="Opportunity descripty">Opportunity Description</label>
                            </div>
...
export default OpportuntiyForm
