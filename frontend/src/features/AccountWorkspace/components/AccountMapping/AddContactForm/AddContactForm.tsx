...
// type AddContactFormProps = { onAddContact: (newContact: Contact) => void; onCancel: () => void; };

// const CATEGORY_CHOICES = [
//   ['plant_head','Plant Head'],['purchase_head','Purchase Head'],['it_head','IT Head'],
//   ['quality_head','Quality Head'],['production_head','Production Head'],['plant_pic','Plant PIC'],
//   ['purchase_pic','Purchase PIC'],['it_pic','IT PIC'],['quality_pic','Quality PIC'],['production_pic','Production PIC'],
// ];
...
// const AddContactForm: React.FC<AddContactFormProps> = ({ onAddContact, onCancel }) => {
//   const [newContact, setNewContact] = useState<Contact>({ category: '', name: '', designation: '', mobile_no: '', email_id: '' });
...
const AddContactForm: React.FC<AddContactFormProps> = ({ onAddContact, onCancel }) => {
  ...
  // ← Wrap modal JSX in createPortal so it renders into document.body
  return createPortal(
    ...
    document.body   // ← renders outside any overflow container
  );
};
