...
// import { addPicDetails } from "../../slice/EditOpportunityWorkspace";
...
//   useEffect(() => {
//     if (formData?.opportunity_pic && formData.opportunity_pic.length > 0) {
//       const picDetails = formData.opportunity_pic[0]; // Assuming you want the first item
//       setLocalFormData({
//         pic_department: picDetails.pic_department || "",
//         pic_name: picDetails.pic_name || "",
//         pic_designation: picDetails.pic_designation || "",
//         pic_email: picDetails.pic_email || "",
//         pic_phnone: picDetails.pic_phnone || "",
//         pic_phntwo: picDetails.pic_phntwo || "",
//       });
//     }
//   }, [formData?.opportunity_pic]);  // Dependency array checks for formData
...
//     const userConfirmed = window.confirm("Do you want to update the PIC details?");
...
// import PicEditCard from "./PicEditCard/PicEditCard";
// import { addPicDetails } from "../../slice/AdminEditOpportunityWorkspaceSlice";
