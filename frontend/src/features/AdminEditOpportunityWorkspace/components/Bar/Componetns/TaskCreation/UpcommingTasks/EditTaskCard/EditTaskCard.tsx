...
// import {  updateTask } from "../../../../../../slice/AdminEditOpportunityWorkspaceSlice";
...
const selectClass =
  "w-full px-3 py-2 rounded-xl border-2 border-slate-200 bg-white text-sm text-slate-800 font-medium focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400 transition-all duration-200 [&>option]:text-slate-800 [&>option]:font-medium";
    ...
    <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-white w-full max-w-sm rounded-2xl shadow-2xl border-2 border-blue-100 overflow-hidden">
        ...
        <div className="px-5 py-4 flex flex-col gap-4 bg-white">
          ...
          {/* Assign To */}
          <div className="flex flex-col gap-1.5">
            <label htmlFor="assign_to" className="text-sm font-semibold text-slate-700">Assign To</label>
            <input
              type="text"
              id="assign_to"
