...
//             <span className={styles.countBadge}>{displayTasks.length}</span>
//           )}
//         </h2>
...
//             <Cards 
//               key={i}
//               taskIndex={allTasks.indexOf(t)} // Preserves exact index for Redux actions
//               task={t.task}
//               assign_to={t.assign_to}
//               start_date={t.start_date}
//               end_date={t.end_date}
...
const UpcomingTasks: React.FC = () => {
  ...
  return (
    <div className="rounded-2xl border-2 border-blue-100 shadow-lg overflow-hidden h-full flex flex-col">
      ...
      {/* Gradient Header */}
      <div className="bg-gradient-to-r from-blue-600 to-indigo-500 px-5 py-3 flex items-center justify-between shrink-0 rounded-t-2xl">
